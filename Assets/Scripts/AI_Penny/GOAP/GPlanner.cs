...
{
    public Queue<GAction> plan(List<GAction> actions, Dictionary<string, int> goal, WorldStatesHandle beliefStates)
    {
        ...
        Node start = new Node( null, 0.0f, GWorld.Instance.GetWorldStatesHandle( ).GetStates( ), beliefStates.GetStates( ), null );
